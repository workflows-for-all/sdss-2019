...
- Non-data science collaborators/team members know where to find the latest (or earlier) version of the analysis (code and output)
...
<img src="img/stat540diffmethleuk.png">
source: http://stat545.com/automation01_slides/index.html#/automating-data-analysis-pipelines
---
class: middle
...
.pull-right[
### Script containing order and arguments needed to run analysis:
```
...
- `Make` has a special file called a Makefile that contains the recipe for your analysis
...
# Example problem solved by defined (and shippable) dependencies

**Problem 1:** Code that can only be run on one machine, *and you don't know why...* 😵

**Problem 2:** Long install times when setting up a remote machine for analysis 🙄
...
<img src="img/example_instructions.png">
...
<img src="https://media.giphy.com/media/1BdNuPkEURvkhYQ6vd/giphy.gif">
