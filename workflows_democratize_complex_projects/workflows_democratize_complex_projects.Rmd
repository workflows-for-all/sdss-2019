...
.pull-left[
### Script and literate code docs needed for analysis...
```
predict.py
...
.pull-right[
### Order and arguments needed to run analysis:
```
...
EXPLAIN A BIT ABOUT MAKE (AND RELATED TOOLS HERE)

ecutable analysis scripts & pipelines contribute to democratization of Data Science
